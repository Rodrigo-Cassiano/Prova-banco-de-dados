...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20-Out-2020 às 23:29
...
INSERT INTO `funcionario` (`codigo`, `nome`, `salário`, `codigo_departamento`) VALUES
...
Resposta letra "C" Altera Salario
UPDATE funcionario SET salário  = '5000,00' WHERE código = 3;

Resposta letra "E" Excluir funcionario
